...
--
-- Host: localhost:3306
-- Generation Time: Oct 09, 2021 at 10:20 AM
...
('deepansh', '[{\"db\":\"users721\",\"table\":\"hungry-peoples\"}]');
...
('deepansh', '{\"Console\\/Mode\":\"collapse\"}');
...
-- Database: `users721`
--
CREATE DATABASE IF NOT EXISTS `users721` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `users721`;

-- --------------------------------------------------------

--
-- Table structure for table `hungry-peoples`
--

CREATE TABLE `hungry-peoples` (
  `Sno` int NOT NULL,
...
--
-- Dumping data for table `hungry-peoples`
--
...
CREATE TABLE `products` (
  ...
  `get-recepies` varchar(255) NOT NULL DEFAULT 'cs.php',
  `orderfood` varchar(255) NOT NULL DEFAULT 'cs.php',
...
--
-- Indexes for table `hungry-peoples`
--
ALTER TABLE `hungry-peoples`
  ADD PRIMARY KEY (`Sno`),
...
--
-- AUTO_INCREMENT for table `hungry-peoples`
--
ALTER TABLE `hungry-peoples`
...
--
ALTER TABLE `wishlist`
  MODIFY `Sno` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
COMMIT;
